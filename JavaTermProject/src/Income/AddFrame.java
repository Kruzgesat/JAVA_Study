...
public class AddFrame extends JFrame implements ActionListener{
	...
	private IncomeUI tmpIncome;
	private Font inputFont;
	
	public AddFrame(IncomeUI income) {
		setTitle("급여 추가");
        setSize(600, 330);
        setResizable(false);
	...
	private void createCenterPanel() {				//데이터 입력 패널
		...
		String[] columnNames = {"Name", "Workingtime", "Salary per hour", "Salary Payout Date"};
